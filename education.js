...
var data = [
	{
		date: 2015,
		position: "Programa ejecutivo en Corporate Performance Management",
	...
	{
		date: 1982,
		position: "Selectividad",
		location: "Isaac Peral de Cartagena ",
		url: ""
	}
];
...
r.push("</table>");
document.getElementById("education").innerHTML = r.join("\n");
